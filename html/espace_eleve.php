            ...
            <section class="formations-container">
                <div class="formation-block">
                    ...
                    <div class="formation-content">
                        <form action="espace_eleve.php" method="POST"
                            ...
                            <input type="number" name="permanence_id" required
                                style="width: 100%; padding: 10px; margin-bottom: 20px; border-radius: 5px; border: none; font-family: 'Roboto', sans-serif;">

                            <button type="submit"
                                style="padding: 12px; background: #4da6ff; color: #002244; border: none; border-radius: 5px; font-weight: bold; font-size: 1.1rem; cursor: pointer;">S'inscrire</button>
                        </form>
                    </div>
                </div>
                ...
                <div class="formation-block">
                    ...
                    <div class="formation-content" id="mes-permanences" style="padding-top: 15px;">
                        <p style="font-style: italic; opacity: 0.8;">Vous n'êtes inscrit à aucune permanence pour le
                            moment.</p>
                    </div>
                </div>
            </section>
